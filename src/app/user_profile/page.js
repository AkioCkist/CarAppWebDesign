        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              custom={1} // Sidebar animation delay order
              className="lg:w-1/4"
            >
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <nav className="space-y-2">
                  <a href="#" className="flex items-center px-3 py-2 text-sm font-medium text-white bg-green-500 rounded-md">
            ...
            <div className="lg:w-3/4 space-y-6">
              ...
              <motion.div
                ...
                initial="hidden"
                animate="visible"
                custom={2} // Stats cards animation delay order
              ...
              >
                ...
                <div className="bg-white rounded-lg p-6 text-center shadow-sm">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800">{userData.completedRides}</h3>
                ...
                <div className="bg-white rounded-lg p-6 text-center shadow-sm">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800">{userData.totalBookings}</h3>
                ...
                <div className="bg-white rounded-lg p-6 text-center shadow-sm">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800">{userData.totalCars}</h3>
              ...
              <motion.div
                ...
                initial="hidden"
                animate="visible"
                custom={3} // Recent orders animation delay order
