      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="flex-1">
          <input
            ...
            className="w-full p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-500 text-gray-700 font-semibold"
            value={searchTerm}
