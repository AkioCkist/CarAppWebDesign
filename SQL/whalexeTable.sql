...
(1, 3, 'Toyota Vios 2023', 4.8, 125, 'TP.HCM - 456 Lê Văn Sỹ, Phường 14, Quận 3', 'Số tự động', 4, 'Xăng', 900000.00, 'sedan', 'Xe gia đình tiết kiệm nhiên liệu, phù hợp cho di chuyển trong thành phố và du lịch ngắn ngày.', 'available', TRUE, '2025-05-01 08:00:00', '2025-05-31 09:00:00'),
(2, 3, 'Honda CR-V 2024', 4.9, 180, 'Hà Nội - 123 Trần Phú, Ba Đình, Hà Nội', 'Số tự động', 7, 'Xăng', 1500000.00, 'suv', 'SUV rộng rãi, phù hợp cho gia đình và du lịch xa.', 'rented', FALSE, '2025-05-02 09:00:00', '2025-05-31 10:00:00'),
(3, 3, 'Kia Morning 2022', 4.5, 200, 'Đà Nẵng - 567 Nguyễn Văn Linh, Hải Châu, Đà Nẵng', 'Số sàn', 4, 'Xăng', 500000.00, 'hatchback', 'Xe nhỏ gọn, tiết kiệm, lý tưởng cho di chuyển nội đô.', 'available', FALSE, '2025-05-03 07:00:00', '2025-05-31 08:00:00'),
(4, 3, 'Mazda CX-5 2023', 4.7, 150, 'Huế - 234 Lê Lợi, Phú Hậu, Huế', 'Số tự động', 5, 'Xăng', 1200000.00, 'crossover', 'Xe crossover mạnh mẽ, phong cách, phù hợp mọi địa hình.', 'maintenance', TRUE, '2025-05-04 06:00:00', '2025-05-31 07:00:00'),
(5, 3, 'Ford Ranger 2024', 4.6, 90, 'Bắc Ninh - 789 Nguyễn Trãi, Suối Hoa, Bắc Ninh', 'Số tự động', 5, 'Dầu', 1800000.00, 'pickup', 'Xe bán tải mạnh mẽ, phù hợp cho công việc và du lịch địa hình.', 'available', FALSE, '2025-05-05 05:00:00', '2025-05-31 06:00:00')
ON DUPLICATE KEY UPDATE 
...
(1, 'https://example.com/car1_1.jpg', TRUE, 1, '2025-05-01 08:00:00'),
(1, 'https://example.com/car1_2.jpg', FALSE, 2, '2025-05-01 08:00:00'),
(1, 'https://example.com/car1_3.jpg', FALSE, 3, '2025-05-01 08:00:00'),
(2, 'https://example.com/car2_1.jpg', TRUE, 1, '2025-05-02 09:00:00'),
(2, 'https://example.com/car2_2.jpg', FALSE, 2, '2025-05-02 09:00:00'),
(3, 'https://example.com/car3_1.jpg', TRUE, 1, '2025-05-03 07:00:00'),
(4, 'https://example.com/car4_1.jpg', TRUE, 1, '2025-05-04 06:00:00'),
(4, 'https://example.com/car4_2.jpg', FALSE, 2, '2025-05-04 06:00:00'),
(5, 'https://example.com/car5_1.jpg', TRUE, 1, '2025-05-05 05:00:00')
ON DUPLICATE KEY UPDATE 
...
--
DROP TRIGGER IF EXISTS `before_vehicle_image_insert`;
DELIMITER $$
...
DROP TRIGGER IF EXISTS `before_vehicle_image_update`;
DELIMITER $$
